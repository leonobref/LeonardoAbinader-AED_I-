...
Lista inverter_lista(Lista *L){
    ...
    Elemento *i, *ult;
    inicializa_lista(&out);
    lista_copiar_nao_inicializada(L, &aux);
...
void lista_copiar_inicializada(Lista *L1, Lista *L2){
...
//Copia os elementos de L1 para L2 sendo L2 uma lista nao inicializada.
void lista_copiar_nao_inicializada(Lista *L1, Lista *L2){
    inicializa_lista(L2);
